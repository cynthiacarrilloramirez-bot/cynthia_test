...
# Using function left_joint to merge two data sets
...
# Making birds_full data set with bird_subset and sites
...
# Left_join() to mereg data of birds subset and taxalist
...
```{r}
birds_observations <- bird_observations %>%rename(birds_obs_notes= notes)
```
